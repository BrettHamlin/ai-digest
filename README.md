...
- `--stdout`: Write digest content to stdout instead of creating an output file
...
`--stdout` cannot be combined with `--watch`; watch mode always regenerates an output file.
